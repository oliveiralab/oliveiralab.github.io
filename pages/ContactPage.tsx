...
const ContactPage: React.FC = () => {
  ...
  return (
    <Section title="Get In Touch" subtitle={`I'd love to hear from you. For questions, collaboration ideas, or to learn more about my work, please use the contact methods below.`}>
