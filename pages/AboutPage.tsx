      ...
      <Section title="My Vision & Mission">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="mt-8 md:mt-0">
            <img 
              src="https://images.pexels.com/photos/8420658/pexels-photo-8420658.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=1" 
              alt="A drone flying over a lush green agricultural field, representing the integration of technology in modern farming." 
